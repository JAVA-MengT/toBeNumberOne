...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b92592e4241f480688f7ac7ab07da281~tplv-k3u1fbpfcp-zoom-1.image)
...
小伙伴不要把过多的精力放到 SpEL 表达式上，简单学会一些基础的使用即可，更多的 SpEL 表达式使用方式，可以参照官方文档，这上面写的非常全：[https://docs.spring.io/spring/docs/5.2.x/spring-framework-reference/core.html#expressions](https://docs.spring.io/spring/docs/5.2.x/spring-framework-reference/core.html#expressions) 。
